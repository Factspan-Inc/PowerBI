...
const Vpleads = () => {
  ...
  const handleToggle = () => {
    setSelectedOption((prevOption) => {
      const newOption = prevOption === "Lead" ? "Sold" : "Lead";
      // Perform any logic using the latest selected option (newOption) here
      console.log("Latest selected option:", newOption);
      return newOption;
    });
  };
  ...
  const vpLeadsData = [5, 40, 10, 30, 10, 5];
  const vpSoldLeadsData = [16, 18, 40, 20,16,10]
  ...
  {selectedOption === 'Sold' && (
    <div className="chart-lead-bucket">Sold Probability Bucket</div>
  )}
  </div>
  <div className="row value-chart">
    <div className="chart-containers col-md-6">
      <ChartVpLeads chartData={selectedOption === 'Lead' ? vpLeadsData : vpSoldLeadsData} />
    </div>
                  <div className="col-md-4 legend-main">
                    <div className="legend">
                      <div
                        className="legend-circle"
                        style={{ backgroundColor: "#717BC5" }}
                      ></div>
            ...
            <div>
              <div
                className="col-md-12 table-name"
          ...
          <div className="col-md-2">
            ...
            <div className="note">
              <span>Note:</span> Please click on booking number and give
              feedback back for the same.
            </div>
          </div>
        </div>
      </div>
